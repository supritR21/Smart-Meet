...
const pricingCardIconVariants = cva("size-5", {
    // Lucide icons use stroke="currentColor" by default, so use text color
    // utilities to control the stroke (check) color rather than fill.
    variants: {
        variant: {
            // default (light background): make the icon stroke the primary color
            default: "text-primary",
            // highlighted (dark background): white stroke
